 ...
 * @param options - See {@link MultiPlaneRenderOptions}.
 * @returns A record keyed by palette entry name; each value is the 1bpp
 *   plane for that ink colour. Dimensions match the input (or are swapped
 *   when `rotate` is 90 or 270).
 * @throws {RangeError} On empty palette, > 254 entries, duplicate plane
 ...
 *
 * @example Brother QL-800 with red/black tape
 * ```ts
